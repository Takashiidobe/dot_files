...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/takashi/.local/share/lunarvim/site/pack/packer/start/copilot.vim"
  },
  ["dashboard-nvim"] = {
  ...
  ["goyo.vim"] = {
    loaded = true,
    path = "/Users/takashi/.local/share/lunarvim/site/pack/packer/start/goyo.vim"
  },
  ["lualine.nvim"] = {
  ...
  ["vim-strip-trailing-whitespace"] = {
    loaded = true,
    path = "/Users/takashi/.local/share/lunarvim/site/pack/packer/start/vim-strip-trailing-whitespace"
  },
  ["which-key.nvim"] = {
